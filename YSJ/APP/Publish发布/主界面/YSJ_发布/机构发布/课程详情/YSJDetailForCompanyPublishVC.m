...
-(void)save{
    ...
    [self.delegate getDetailText:self.headerView.textView.text courseImgArr:self.headerView.photos teacherIdArr:teacherIdArr courseTim:self.headerView.classTime.rightSubTitle courseNum:self.headerView.classNums.rightSubTitle];
