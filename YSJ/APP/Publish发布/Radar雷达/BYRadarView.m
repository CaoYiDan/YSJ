...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        _color = [UIColor colorWithRed:255 / 255.0 green:218 / 255.0 blue:69 / 255.0 alpha:1];//[UIColor purpleColor];//
...
-(void)drawRect:(CGRect)rect
{
    ...
    CGContextSetRGBStrokeColor(ctx,250/255.0,198 / 255.0,228 / 255.0,1);//画笔线的颜色
