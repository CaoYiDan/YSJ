...
-(void)setupUI {
    ...
    [self.doneBtn setTitle:@"确定" forState:0];
    [self.doneBtn setTitleColor:[UIColor whiteColor] forState:0];
    
    UILabel *    sure = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, self.doneBtn.frameWidth, self.doneBtn.frameHeight)];
    sure.font = font(16);
    sure.text = @"确定";
