...
-(void)initBottomView{
    UIView *bottomView = [[UIView alloc]initWithFrame:CGRectMake(0, SCREEN_H2-SafeAreaBottomHeight-44,SCREEN_W, 44)];
    self.bottomView = bottomView;
    [self.view addSubview:bottomView];
 
    self.btnDone = [[UIButton alloc]initWithFrame:CGRectMake(SCREEN_W/2-60, 2, 120, 40)];
    self.btnDone.layer.cornerRadius = 5;
    self.btnDone.clipsToBounds = YES;
    [self.btnDone setTitle:@"确定" forState:0];
    [self.btnDone addTarget:self action:@selector(btnDone_Click:) forControlEvents:UIControlEventTouchDown];
    [bottomView addSubview:self.btnDone];
}
...
- (void)initCollectionView
{
    ...
    self.collectionView.contentInset = UIEdgeInsetsMake(SafeAreaTopHeight, 0, SafeAreaBottomHeight+44+SafeAreaTopHeight+40, 0);
