...
- (void)viewDidLoad {
    ...
    self.dataArr =
    @[@{@"img":@"",@"text":@"头像",@"pushVC":@""},@{@"img":@"",@"text":@"昵称",@"pushVC":@""},@{@"img":@"",@"text":@"性别",@"pushVC":@""},@{@"img":@"",@"text":@"手机号",@"pushVC":@""}];
...
-(void)creatAlertController_alert {
    ...
    UIAlertAction *action1 = [UIAlertAction actionWithTitle:@"确定" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
      ...
      self.model.nickname = alert.textFields.lastObject.text;
       [self changeValue:self.model.nickname forKey:@"nickname"];
       [StorageUtil saveNickName:self.model.nickname];
...
-(void)setTableView{
    ...
    self.tableView=[[UITableView alloc]initWithFrame:CGRectMake(0, 0, kWindowW, kWindowH-KBottomHeight-70) style:UITableViewStylePlain];
