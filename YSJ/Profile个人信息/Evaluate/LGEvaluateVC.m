...
-(void)viewWillAppear:(BOOL)animated{
    ...
    UIButton *commitBtn = [[UIButton alloc]initWithFrame:CGRectMake(20, SCREEN_H2-50, SCREEN_W-40, 40)];
...
-(void)commit{
    ...
    vc.beCommented = self.mainCode;
    vc.beCommentedCode = self.mainCode;
    vc.type= @"USER";
    WeakSelf;
...
-(void)loadMore{
    ...
    [[HttpRequest sharedClient]httpRequestPOST:kUrlBase parameters:dict progress:nil sucess:^(NSURLSessionDataTask *task, id responseObject, ResponseObject *obj) {
        ...
        NSMutableArray *arr = (NSMutableArray *)[LGEvaluateStatus mj_objectArrayWithKeyValuesArray:responseObject[@"list"]];
...
-(void)loadData{
   ...
   [[HttpRequest sharedClient]httpRequestPOST:kUrlCommnetList parameters:dict progress:nil sucess:^(NSURLSessionDataTask *task, id responseObject, ResponseObject *obj) {
       ...
       NSMutableArray *arr = (NSMutableArray *)[LGEvaluateStatus mj_objectArrayWithKeyValuesArray:responseObject[@"data"]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    LGEvaluateStatusFrame *statusFrame = self.dataArr[indexPath.row];
...
//    LGEvaluateStatusFrame *model = self.dataArr[index];
