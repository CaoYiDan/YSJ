...
//-(UIButton*)starBenfit{
//    if (!_starBenfit) {
//        _starBenfit=[[UIButton alloc]initWithFrame:self.view.bounds];
//        [ _starBenfit addTarget:self action:@selector(click:) forControlEvents:UIControlEventTouchUpInside];
//        [self.view addSubview:_starBenfit];
