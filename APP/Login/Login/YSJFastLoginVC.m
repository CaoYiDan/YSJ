...
- (void)createUI{
    ...
    UIView *phoneBaseView = [[UIView alloc]init];
    phoneBaseView.backgroundColor = [UIColor hexColor:@"F5F5F5"];
    phoneBaseView.layer.cornerRadius = 4;
    phoneBaseView.clipsToBounds = YES;
    [centerView addSubview:phoneBaseView];
    [phoneBaseView mas_makeConstraints:^(MASConstraintMaker *make) {
    ...
    [phoneBaseView addSubview:getMaBtn];
    ...
    [phoneBaseView addSubview:_phoneTF];
    ...
    passwordBaseView.backgroundColor = [UIColor hexColor:@"F5F5F5"];
    passwordBaseView.layer.cornerRadius = 4;
    passwordBaseView.clipsToBounds = YES;
    [centerView addSubview:passwordBaseView];
    ...
    [passwordBaseView addSubview:_phoneCodeTF];
