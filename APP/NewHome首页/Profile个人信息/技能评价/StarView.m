...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event{
    if (self.canSelected) {//可以选择
        ...
        NSInteger ok=self.show_star/20;
        self.show_star=self.show_star%20==0?self.show_star:ok*20+20;
        self.show_star=self.show_star<=20?20:self.show_star;
       !self.StarBlock?:self.StarBlock(self.show_star);
        //重新绘制
