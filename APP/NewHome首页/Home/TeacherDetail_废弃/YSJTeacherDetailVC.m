...
@interface YSJTeacherDetailVC () <SPPageMenuDelegate,UIScrollViewDelegate>
...
@implementation YSJTeacherDetailVC
...
- (YSJTeacherHeaderView *)headerView {
    
    if (!_headerView) {
        _headerView = [[YSJTeacherHeaderView alloc] init];
...
- (SPPageMenu *)pageMenu {
    ...
    if (!_pageMenu) {
        ...
        [_pageMenu setItems:@[@"可售课程",@"个人展示",@"动态"] selectedItemIndex:1];
        _pageMenu.delegate = self;
        _pageMenu.itemTitleFont = Font(15);
        _pageMenu.selectedItemTitleColor = KMainColor;
