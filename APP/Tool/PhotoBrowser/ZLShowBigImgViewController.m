...
- (void)viewDidLayoutSubviews
{
    ...
    CGRect frame = _hideNavBar?CGRectMake(0, kViewHeight, kViewWidth, 44):CGRectMake(0, kViewHeight-44-SafeAreaBottomHeight, kViewWidth, 44);
...
- (void)initBottomView
{
    ...
    _bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, kViewHeight - 44-SafeAreaBottomHeight, kViewWidth, 44)];
