...
-(void)next{
    ...
    NSLog(@"%@",dic);
    [[HttpRequest sharedClient]httpRequestPOST:YOrderDrawBack parameters:dic progress:nil sucess:^(NSURLSessionDataTask *task, id responseObject, ResponseObject *obj) {
