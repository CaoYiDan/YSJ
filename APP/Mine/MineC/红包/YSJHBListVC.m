...
-(void)setRightItem{
    ...
    UIButton *rightItem = [FactoryUI createButtonWithtitle:@"创建红包" titleColor:KWhiteColor imageName:@"" backgroundImageName:@"" target:self selector:@selector(createHB)];
    rightItem.frame = CGRectMake(0, 0, 44, 44);
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc]initWithCustomView:rightItem];
    
   
    [[HttpRequest sharedClient]httpRequestPOST:Yredpackettime parameters:@{} progress:nil sucess:^(NSURLSessionDataTask *task, id responseObject, ResponseObject *obj) {
...
-(void)createHB{
    YSJCreateHBVC *vc = [[YSJCreateHBVC alloc]init];
