...
- (UIViewController *)magicView:(VTMagicView *)magicView viewControllerAtPage:(NSUInteger)pageIndex {
    ...
    if (pageIndex==0) {
        ...
        YSJChildProfileLeftVC *viewController = [magicView dequeueReusablePageWithIdentifier:gridId];
        if (!viewController) {
            viewController = [[YSJChildProfileLeftVC alloc] init];
        }
