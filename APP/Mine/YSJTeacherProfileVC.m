...
#import "YSJTeacherProfileVC.h"
#import "CMInputView.h"
#import "YSJUserModel.h"
#import "BDImagePicker.h"

@interface YSJTeacherProfileVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation YSJTeacherProfileVC
{
    CGFloat cellHeight;
...
-(void)setData{
    self.dataArr =
    @[ @[@{@"img":@"",@"text":@"头像",@"pushVC":@""},@{@"img":@"",@"text":@"昵称",@"pushVC":@"",@"key":@"nickname",@"value":[self getNotNullWith:self.model.nickname]},@{@"img":@"",@"text":@"学校",@"pushVC":@"",@"key":@"sex",@"value":[self getNotNullWith:self.model.company_school]},@{@"img":@"",@"text":@"生日",@"pushVC":@"",@"key":@"birth",@"value":[self getNotNullWith:self.model.birth]}],
